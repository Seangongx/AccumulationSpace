...
RadiusClusterAlgo::RadiusClusterAlgo() : ClusterAlgoBase(){};
void RadiusClusterAlgo::clearCluster() { ClusterAlgoBase::clearCluster(); }
RadiusClusterAlgo::~RadiusClusterAlgo() { clearCluster(); }

std::vector<std::tuple<int, int, int>> RadiusClusterAlgo::generateNRingNeighbors(int ring) {
  std::vector<std::tuple<int, int, int>> neighbors;
  for (int dx = -ring; dx <= ring; ++dx) {
    for (int dy = -ring; dy <= ring; ++dy) {
      for (int dz = -ring; dz <= ring; ++dz) {
...
void RadiusClusterAlgo::markNRingNeighbours(const AccVoxel& voxel, HashMap2Voxel& mapVoxel, std::queue<AccVoxel>& queue,
                                            int ring) {
  std::vector<std::tuple<int, int, int>> neighbors = generateNRingNeighbors(ring);
